...
export default Ember.Route.extend({
    beforeModel: function(){
        ...
        if( !app_controller.autocompletePoiPort.get('length') ) {
            self.store.findQuery("poi", {tags: "Port", sortBy:"name"}).then(function(val){
        ...
        controller.searchPosition = null;
        controller.searchCode = null;
        controller.searchClassification = null;
        controller.searchSupplier = null;
        controller.searchVoyage = null;
    ...
    actions: {
        searchRecords: function () {
            ...
            app_controller.set('queryRecord', 'equipment');
